...
void main()
{
	int ArregloDeCienEnteros[100];  // Define la variable ArregloDeCienEnteros
	for (int i = 0; i < 100; i++) {  // Crea un bucle en for
		ArregloDeCienEnteros[i] = i;  
...
Funcionamiento:
	En este caso crea un bucle utilizando un for y la idea de este bucle es agregar al arreglo los numeros del 0 al 99
*/
