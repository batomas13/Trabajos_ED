...
void inicializarJugador(nave& jugador, int x) {
	//Se crea la función inicializar jugador que ingresará los valores para cada estructura insertada, en este caso la nave jugador que se inicia a la mitad de la pantalla y en una posición fija en Y 
	jugador.x = x / 2;
	jugador.y = ResY - 100;
	jugador.codigo = 3;
	jugador.estado = true;
